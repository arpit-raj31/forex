  ...
  return (
    <div style={{height:"100vh"}}>
      ...
      <div style={cardContainerStyle}>
        ...
        {/* Astropay Wallet Card */}
        <div style={cardStyle}>
          <div>
            <img src="/image3.jpg" alt="Astropay Wallet" style={{ width: "40px", marginBottom: "10px" }} />
          </div>
          <h3 style={titleStyle}>RazorPay</h3>
          <p style={subTitleStyle}>Processing time Instant - 30 minutes</p>
          <p style={subTitleStyle}>Fee 0 %</p>
          <p style={subTitleStyle}>Limits 10 - 1,000 USD</p>
        </div>
        ...
        <div style={cardStyle}>
          <div>
            <img src="/image4.png
            " alt="Online Bank" style={{ width: "40px", marginBottom: "10px" }} />
          </div>
        ...
        <div style={cardStyle}>
          ...
          <h3 style={titleStyle}>Binanace Pay</h3>
